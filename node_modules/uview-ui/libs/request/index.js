...
class Request {
			...
			options.complete = (response) => {
				...
				if(this.config.originalData) {
					...
					if (this.interceptor.response && typeof this.interceptor.response === 'function') {
						let resInterceptors = this.interceptor.response(response, isToast);
	...
	constructor() {
		...
		// get请求
		this.get = (url, data = {}, isToast = false, header = {}) => {
			return this.request({
				method: 'GET',
				url,
				header,
		...
		// post请求
		this.post = (url, data = {}, isToast = false, header = {}) => {
			return this.request({
				url,
				method: 'POST',
				header,
